...
test("assessment definition schema is valid JSON with the expected shape", () => {
  ...
  for (const def of ["localizedText", "option", "question", "scoreBand", "scoreFlag", "sumScoring", "subscale", "subscaleScoring", "countScoringItem", "countScoring", "missingDataPolicy"]) {
